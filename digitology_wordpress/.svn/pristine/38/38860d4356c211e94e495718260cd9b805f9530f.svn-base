...
(function forkitGreen(){
	...
	function initialize() {
		...
		dom.ribbon = document.querySelector( '.green-forkit' );
		dom.curtain = document.querySelector( '.green-forkit-curtain' );
		dom.closeButton = document.querySelector( '.green-forkit-curtain .close-buttonz' );
