...
<span class="TestimonalsTitleBlack">HIGH FIVES</span></div>
           ...
           <?php //include("ThemeGreen/testimonials.php"); ?>
            ...
            <!-- Social Container End --->
             <div id="contentGreenValue" style="" class="AboutContainer P-about timer_stop_start"></div>
            <!--- Footer Container -->
	...
	<?php include 'ThemeBlue/menu.php';?>		
            ...
            <div class="TitleMarginForHeading">
                <div class="TitleHeading TitleColorP"><h1 class="h1strong"><div class="h1textheading">dashboard Development</div></h1></div>
            </div>
...
<span class="TestimonalsTitleBlack">HIGH FIVES</span></div>
            ...
            <div id="contentBlueValue" class="AboutContainer P-about timer_stop_start">
...
<span class="TestimonalsTitleBlack">HIGH FIVES</span></div>
            ...
            <?php //include("ThemePink/social.php"); ?>
              <div id="contentPinkValue" style="" class="AboutContainer P-about timer_stop_start"></div>
            <!-- Social Container End --->
