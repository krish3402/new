...
//include "db.php";
 ...
 $string=$row[post_content];
    ...
    echo "<p class='NormalText NormalPcolor search_Pink_page' id='search_content_ul'><span class='SocialSubTitle'><a href='#' onclick='showPinkMenuContent(this.id)' id='$row[post_title]'>$row[post_title]</a><br><p class='NormalPcolor NormalText'>$site</p></span></br>
...
<script>
    $(document).ready(function(){
        ...
        $(".search_Pink_page a").click(function () {
