...
//include "db.php";
 ...
 echo "<section id='demo' style='padding-bottom:15px'><div class='TitleHeading TitleColorP TitleMargin' style='padding-top:10px;'>Search Results For :$title</div>";
...
$site=site_url().'/'.$row[post_title].'/';
    echo "<p class='NormalText NormalPcolor search_green_page' id='search_content_ul'><span class='SocialSubTitle'><a href='#' onclick='showGreenMenuContent(this.id)' id='$row[post_title]'>$row[post_title]</a><br><p class='NormalPcolor NormalText'>$site</p></span></br>
...
<script>
    $(document).ready(function(){
        ...
        $(".search_green_page a").click(function () {
